...
export class AgentService {
  ...
  private executeCommand(command: AgentCommand): Observable<AgentCommandResult> {
    const request$: Observable<AgentCommandResult> = this.post(command);
    return request$.pipe(
  ...
  private executeQuery(query: AgentQuery): Observable<AgentQueryResult> {
    return this.httpClient.post<AgentQueryResult>(`${this.apiBaseUrl}/agent/chats/{chatId}`, query.chatId, {
  ...
  private post(command: AgentCommand): Observable<AgentCommandResult> {
